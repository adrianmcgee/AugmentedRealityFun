...
protocol ARViewControllerProtocol : class
{
    func method()
}
...
//    open func instanceFromNib() -> UIView {
//        return UINib(nibName: "plantOverlayView", bundle: nil).instantiate(withOwner: nil, options: nil)[0] as! UIView
//    }
//
//    open func addView(){
//        print("ARVIEW add view")
//        let viewFromNib: UIView? = instanceFromNib()
//        viewFromNib?.frame = CGRect(x: 0, y: 0, width: self.view.frame.size.width, height: self.view.frame.size.height)
...
//    }
    ...
    var childViewVC: AnnotationView?
    ...
    internal func arTrackingManager(_ trackingManager: ARTrackingManager, didUpdateUserLocation: CLLocation?)
    {
        ...
        let myLocation = CLLocation(latitude: -37.87821516, longitude: 145.06718944)
...
//         print("Hello")
//        print("ARVIEW add view")
//        let viewFromNib: UIView? = UINib(nibName: "plantOverlayView", bundle: nil).instantiate(withOwner: nil, options: nil)[0] as! UIView
//        viewFromNib?.frame = CGRect(x: 0, y: 0, width: self.view.frame.size.width, height: self.view.frame.size.height)
//        self.view.addSubview(viewFromNib!)
//    }
//}
